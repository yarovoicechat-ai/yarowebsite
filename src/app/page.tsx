      ...
      <section className="relative pt-12 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            {/* Live Release Badge */}
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl shadow-xl">
              <span className="flex h-2.5 w-2.5 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-pink-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-pink-500" />
              </span>
              <span className="text-xs font-extrabold text-zinc-200 uppercase tracking-wide">
                Voice Calling & Group Rooms • <span className="text-pink-400">Live App v1.8.4</span>
              </span>
            </div>
            ...
            <p className="text-zinc-300 text-base sm:text-xl max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
              Experience crystal-clear 1-on-1 voice calling, 9-seat group audio party lounges, 3D animated virtual gifts, and instant global connections on <strong className="text-white">Meethi Chat</strong>.
            </p>
